...
Trabalho executado via Canva: transições e elementos visuais
<img width="1211" height="677" alt="image" src="https://github.com/user-attachments/assets/adc05fa2-8d7d-455a-b9c6-380babd7c68f" />
...
## Atividade no excel realizada dia 06/03/2026 - balancete (tabela)
Articulação de tabela e montagem do gráfico baseado em dados abertos da prefeitura de São José dos Campos
<img width="607" height="396" alt="image" src="https://github.com/user-attachments/assets/03763ef3-cbcf-4bcd-a488-a1e7bf647fca" />

## Atividade no excel realizada dia 12/03/2026 - despesa (tabela)
Criação de gráfico baseado em dados abertos da prefeitura de São José dos Campos
<img width="887" height="437" alt="image" src="https://github.com/user-attachments/assets/64afadad-9604-43d2-9c9a-da808c7738bf" />

## Atividade no excel realizada dia 13/03/2026 - fornecedores (tabela)
Reforço da aula do dia 12/03 de criação de gráficos baseado em dados abertos
